...
type MarketData struct {
	...
	Exchange  string  `protobuf:"bytes,1,opt,name=exchange,proto3" json:"exchange,omitempty"`              // e.g., "BINANCE", "COINBASE", "KRAKEN"
	Symbol    string  `protobuf:"bytes,2,opt,name=symbol,proto3" json:"symbol,omitempty"`                  // e.g., "BTCUSDT"
	Timestamp int64   `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`           // epoch milliseconds
	Price     float64 `protobuf:"fixed64,4,opt,name=price,proto3" json:"price,omitempty"`                  // trade price
	Size      float64 `protobuf:"fixed64,5,opt,name=size,proto3" json:"size,omitempty"`                    // trade size/quantity
	TradeId   string  `protobuf:"bytes,6,opt,name=trade_id,json=tradeId,proto3" json:"trade_id,omitempty"` // exchange-specific trade identifier
}
...
func (x *MarketData) GetSize() float64 {
	if x != nil {
		return x.Size
	}
	return 0
...
var file_trade_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x74, 0x72, 0x61, 0x64, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x6d,
	0x61, 0x72, 0x6b, 0x65, 0x74, 0x22, 0xa3, 0x01, 0x0a, 0x0a, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	...
	0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61, 0x64, 0x65, 0x49, 0x64, 0x42, 0x0d, 0x5a, 0x0b, 0x6d,
...
var file_trade_proto_goTypes = []interface{}{
	(*MarketData)(nil), // 0: market.MarketData
}
